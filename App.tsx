...
const ChatModal: React.FC<ChatModalProps> = ({ 
    ...
    newMessage, setNewMessage, isSending, setIsSending, onTextSubmit
}) => {
    ...
    }, [partner, correctionsEnabled, userProfile, onMessagesChange, isSending, setIsSending]);
    ...
    useEffect(() => {
      ...
      if (lastMessage?.sender === 'user' && !isFetchingResponse.current && !groupChat) {
